        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("VibeAi needs the following permissions to work properly.")
                        .scaledFont(size: 14)
                ...
                if !appState.hasMissingPermissions {
                    HStack(spacing: 12) {
                        ...
                        Text("All permissions granted! VibeAi is ready to use.")
...
struct MicrophonePermissionSection: View {
    ...
    private var iconBackgroundColor: Color {
        if appState.hasMicrophonePermission {
            ...
            return VibeAIColors.backgroundTertiary
        }
    }
    ...
    private var borderColor: Color {
        if appState.hasMicrophonePermission {
            ...
            return VibeAIColors.backgroundQuaternary.opacity(0.5)
        }
    }
    ...
    var body: some View {
                ...
                HStack(spacing: 16) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text(isPermissionDenied
                            ...
                            .scaledFont(size: 13)
                            .foregroundColor(isPermissionDenied ? .red.opacity(0.8) : VibeAIColors.textTertiary)
                    }
        ...
        .background(
            RoundedRectangle(cornerRadius: 16)
                .fill(isPermissionDenied ? Color.red.opacity(0.05) : VibeAIColors.backgroundSecondary.opacity(0.5))
                .overlay(
                    RoundedRectangle(cornerRadius: 16)
    ...
    private var microphoneStatusBadge: some View {
        ...
        .foregroundColor(appState.hasMicrophonePermission ? .green : (isPermissionDenied ? .red : VibeAIColors.warning))
        .padding(.horizontal, 8)
        .padding(.vertical, 4)
        .background(
            Capsule()
                .fill(appState.hasMicrophonePermission ? Color.green.opacity(0.15) : (isPermissionDenied ? Color.red.opacity(0.15) : VibeAIColors.warning.opacity(0.15)))
        )
    }
    ...
    private var deniedStateContent: some View {
        VStack(alignment: .leading, spacing: 16) {
                ...
                Button(action: tryDirectReset) {
                    ...
                    .background(
                        RoundedRectangle(cornerRadius: 10)
                            .fill(isResetting ? Color.gray : VibeAIColors.purplePrimary)
                    )
                }
                .buttonStyle(.plain)
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                // Step 2: Find VibeAi and toggle ON
                HStack(alignment: .top, spacing: 8) {
                    Text("2.")
                        .scaledFont(size: 13, weight: .semibold)
                        .foregroundColor(VibeAIColors.textSecondary)
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        Text("Find \"VibeAi\" and toggle it ON")
                            .scaledFont(size: 13)
                            .foregroundColor(VibeAIColors.textSecondary)
    ...
    private var notDeterminedStateContent: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                instructionStep(number: 3, text: "If no dialog appears, find \"\(Bundle.main.object(forInfoDictionaryKey: "CFBundleDisplayName") as? String ?? "VibeAi")\" in Settings and enable it")
            }
...
struct ScreenRecordingPermissionSection: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            ...
            Button(action: { withAnimation { isExpanded.toggle() } }) {
                HStack(spacing: 16) {
                    ...
                    ZStack {
                        Circle()
                            .fill(appState.isScreenRecordingStale ? Color.red.opacity(0.15) : (appState.hasScreenRecordingPermission ? Color.green.opacity(0.15) : VibeAIColors.backgroundTertiary))
                            .frame(width: 48, height: 48)

                        Image(systemName: appState.isScreenRecordingStale ? "rectangle.on.rectangle.slash" : "rectangle.inset.filled.and.person.filled")
                            .scaledFont(size: 22)
                            .foregroundColor(appState.isScreenRecordingStale ? .red : (appState.hasScreenRecordingPermission ? .green : VibeAIColors.textSecondary))
                    }
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text(appState.isScreenRecordingStale
                            ...
                            .scaledFont(size: 13)
                            .foregroundColor(appState.isScreenRecordingStale ? .red.opacity(0.8) : VibeAIColors.textTertiary)
                    }
        ...
        .background(
            RoundedRectangle(cornerRadius: 16)
                .fill(appState.isScreenRecordingStale ? Color.red.opacity(0.05) : VibeAIColors.backgroundSecondary.opacity(0.5))
                .overlay(
                    RoundedRectangle(cornerRadius: 16)
                        .stroke(appState.hasScreenRecordingPermission ? Color.green.opacity(0.3) : (appState.isScreenRecordingStale ? Color.red.opacity(0.5) : VibeAIColors.backgroundQuaternary.opacity(0.5)), lineWidth: appState.isScreenRecordingStale ? 2 : 1)
                )
        )
    }
    ...
    private var stalePermissionContent: some View {
        let appName = Bundle.main.object(forInfoDictionaryKey: "CFBundleDisplayName") as? String ?? "VibeAi"
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                HStack(alignment: .top, spacing: 12) {
                    Text("1")
                        ...
                        .background(Circle().fill(VibeAIColors.purplePrimary))
                ...
                HStack(alignment: .top, spacing: 12) {
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        Text("Come back to VibeAi and grant the permission")
                            .scaledFont(size: 13)
                            .foregroundColor(VibeAIColors.textSecondary)
    ...
    private var normalGrantContent: some View {
        ...
        return VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                instructionStep(number: 1, text: "Click \"Open Settings\" below - this will make VibeAi appear in the list")
                instructionStep(number: 2, text: "Find \"\(appName)\" in the Screen Recording list")
                instructionStep(number: 3, text: "Toggle the switch to enable screen recording")
                instructionStep(number: 4, text: "Return to VibeAi - permission will update automatically")
            }
...
struct NotificationPermissionSection: View {
    ...
    private var notificationStatusBadge: some View {
        ...
        .foregroundColor(appState.hasNotificationPermission ? .green : (isPermissionDenied ? .red : VibeAIColors.warning))
        .padding(.horizontal, 8)
        .padding(.vertical, 4)
        .background(
            Capsule()
                .fill(appState.hasNotificationPermission ? Color.green.opacity(0.15) : (isPermissionDenied ? Color.red.opacity(0.15) : VibeAIColors.warning.opacity(0.15)))
        )
    }
    ...
    private var notDeterminedStateContent: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 12) {
                ...
                instructionStep(number: 3, text: "Tip: In System Settings > Notifications > VibeAi, set style to \"Banners\" to see visual alerts")
            }
...
private func statusBadge(isGranted: Bool) -> some View {
    ...
    .foregroundColor(isGranted ? .green : VibeAIColors.warning)
    .padding(.horizontal, 8)
    .padding(.vertical, 4)
    .background(
        Capsule()
            .fill(isGranted ? Color.green.opacity(0.15) : VibeAIColors.warning.opacity(0.15))
    )
}
