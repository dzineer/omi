                ...
                GeometryReader { geo in
                    ZStack(alignment: .leading) {
                        ...
                        RoundedRectangle(cornerRadius: 3)
                            .fill(
                                LinearGradient(
                                    colors: [VibeAIColors.purplePrimary, VibeAIColors.purpleSecondary],
                                    startPoint: .leading,
                                    endPoint: .trailing
                                )
                            )
        ...
        ZStack {
            if graphViewModel.isEmpty {
                ...
                VStack(spacing: 12) {
                    ...
                    Text("Your knowledge graph will grow as VibeAi learns more about you")
                        .scaledFont(size: 13)
            ...
            VStack {
                ...
                Button(action: { onComplete(totalFilesScanned) }) {
                    Text("Continue")
                        ...
                        .cornerRadius(12)
                        .shadow(color: VibeAIColors.purplePrimary.opacity(0.4), radius: 16, x: 0, y: 4)
                }
                .buttonStyle(.plain)
                .padding(.bottom, 40)
            }
