...
struct SettingsSearchItem: Identifiable {
    ...
    static let allSearchableItems: [SettingsSearchItem] = [
        ...
        SettingsSearchItem(name: "Ask VibeAi Floating Bar", subtitle: "Configure shortcuts and floating bar behavior", keywords: ["floating bar", "shortcuts", "push to talk"], section: .advanced, advancedSubsection: .askVibeAiFloatingBar, icon: "sparkles", settingId: "advanced.askomi"),
        SettingsSearchItem(name: "AI Model", subtitle: "Choose the AI model for Ask VibeAi conversations", keywords: ["model", "ai", "sonnet", "opus", "claude"], section: .advanced, advancedSubsection: .askVibeAiFloatingBar, icon: "sparkles", settingId: "advanced.askomi.model"),
        SettingsSearchItem(name: "Background Style", subtitle: "Toggle between solid and transparent background", keywords: ["background", "solid", "transparent", "blur"], section: .advanced, advancedSubsection: .askVibeAiFloatingBar, icon: "sparkles", settingId: "advanced.askomi.background"),
        SettingsSearchItem(name: "Draggable Floating Bar", subtitle: "Allow repositioning the floating bar by dragging it", keywords: ["drag", "move", "reposition", "draggable"], section: .advanced, advancedSubsection: .askVibeAiFloatingBar, icon: "sparkles", settingId: "advanced.askomi.draggable"),
        SettingsSearchItem(name: "Ask VibeAi Shortcut", subtitle: "Global shortcut to open Ask VibeAi from anywhere", keywords: ["shortcut", "hotkey", "keyboard", "global shortcut"], section: .advanced, advancedSubsection: .askVibeAiFloatingBar, icon: "sparkles", settingId: "advanced.askomi.shortcut"),
        SettingsSearchItem(name: "Push to Talk", subtitle: "Hold a key to speak, release to send your question to AI", keywords: ["push to talk", "ptt", "hold to talk", "microphone key"], section: .advanced, advancedSubsection: .askVibeAiFloatingBar, icon: "sparkles", settingId: "advanced.askomi.ptt"),
        SettingsSearchItem(name: "Transcription Mode", subtitle: "Choose how voice input is processed", keywords: ["transcription", "mode", "voice", "dictation"], section: .advanced, advancedSubsection: .askVibeAiFloatingBar, icon: "sparkles", settingId: "advanced.askomi.transcriptionmode"),
        SettingsSearchItem(name: "Double-tap for Locked Mode", subtitle: "Double-tap the push-to-talk key to keep listening hands-free", keywords: ["double tap", "locked mode", "hands free", "listening"], section: .advanced, advancedSubsection: .askVibeAiFloatingBar, icon: "sparkles", settingId: "advanced.askomi.doubletap"),
        SettingsSearchItem(name: "Push-to-Talk Sounds", subtitle: "Play audio feedback when starting and ending voice input", keywords: ["sounds", "audio feedback", "ptt sounds"], section: .advanced, advancedSubsection: .askVibeAiFloatingBar, icon: "sparkles", settingId: "advanced.askomi.pttsounds"),
