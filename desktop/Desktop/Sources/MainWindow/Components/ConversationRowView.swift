...
struct ConversationRowView: View {
        ...
        HStack(spacing: 4) {
            ...
            Button(action: {
                ...
                Image(systemName: "pencil")
                    ...
                    .background(Circle().fill(VibeAIColors.backgroundSecondary))
            }
            .buttonStyle(.plain)
            .help("Edit title")
            ...
            if !folders.isEmpty {
                Menu {
                    ...
                    Image(systemName: conversation.folderId != nil ? "folder.fill" : "folder")
                        .scaledFont(size: 11)
                        .foregroundColor(conversation.folderId != nil ? .white : VibeAIColors.textTertiary)
                        .frame(width: 22, height: 22)
                        .background(Circle().fill(VibeAIColors.backgroundSecondary))
                }
            ...
            Button(action: { showDeleteConfirmation = true }) {
                Image(systemName: "trash")
                    .scaledFont(size: 11)
                    .foregroundColor(VibeAIColors.error.opacity(0.8))
                    .frame(width: 22, height: 22)
                    .background(Circle().fill(VibeAIColors.backgroundSecondary))
            }
            .buttonStyle(.plain)
    ...
    private var compactRowContent: some View {
        HStack(spacing: 8) {
            ...
            Button(action: {
                ...
                Image(systemName: conversation.starred ? "star.fill" : "star")
                    .scaledFont(size: 12)
                    .foregroundColor(conversation.starred ? VibeAIColors.amber : VibeAIColors.textTertiary)
        ...
        .background(
            RoundedRectangle(cornerRadius: 8)
                .fill(isSelected ? VibeAIColors.purplePrimary.opacity(0.2) : (isHovering ? VibeAIColors.backgroundTertiary : (isNewlyCreated ? VibeAIColors.purplePrimary.opacity(0.15) : VibeAIColors.backgroundSecondary)))
        )
        .overlay(
            RoundedRectangle(cornerRadius: 8)
                .stroke(isSelected ? VibeAIColors.purplePrimary.opacity(0.5) : Color.clear, lineWidth: 2)
        )
    ...
    private var expandedRowContent: some View {
        ...
        .background(
            RoundedRectangle(cornerRadius: 10)
                .fill(isSelected ? VibeAIColors.purplePrimary.opacity(0.2) : (isHovering ? VibeAIColors.backgroundSecondary : (isNewlyCreated ? VibeAIColors.purplePrimary.opacity(0.15) : VibeAIColors.backgroundTertiary)))
        )
        .overlay(
            RoundedRectangle(cornerRadius: 10)
                .stroke(isSelected ? VibeAIColors.purplePrimary.opacity(0.5) : Color.clear, lineWidth: 2)
